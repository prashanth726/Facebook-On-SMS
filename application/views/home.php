	...
	if(strlen($row->mhash)==0)
	{
		...
		<section class="cbp-so-section">
					<article class="cbp-so-side cbp-so-side-left">
							<h3><?php echo "welcome&nbsp;".  $name;  ?><a href="http://fb-prapps.rhcloud.com/index.php/home/logout">&nbsp;<b style="color:#F00;">Logout</b>&nbsp;</a></h3>
						
<p>Congratulations! You are one step away from enjoying Facebook on your mobile phone.
</p><p>Send #fb.reg to 55444 From your Airtel  to receive a 6 character confirmation pin.
                    ...
                    <img src="<?php echo(IMG.'i.png'); ?>" alt="img01">
                         
                         <br/>
                         
						<?php echo validation_errors(); ?>
 
<?php echo form_open('home/form'); ?>


<input style="margin-top:120px;" type="text" name="username" value="" size="50" />
<input type="hidden" name="provider" value=<?php echo $uid; ?> size="50" />
...
<br/>
	...
	?>	
            ...
            <section class="cbp-so-section">
					<article class="cbp-so-side cbp-so-side-left">
						<h3>Welcome back <?php $name?>"&nbsp;#FB(&#946;)"<a href="http://fb-prapps.rhcloud.com/index.php/home/logout">&nbsp;<b style="color:#F00;">Logout</b>&nbsp;</a></h3>
						<p>
                       You have already registered a device with #FB. If you have changed your phone number and wish to switch the number associated with this account, send a mail to prashanth726@gmail.com with your email id.
                        
					</article>
					<figure style=""  class="cbp-so-side cbp-so-side-right">
                   Successfully done with registration  Scroll down to know more about the app !!
                    <div class="alert alert-error" style="margin-top:55px;">
  <button type="button" class="close" data-dismiss="alert">&times;</button>
  
<h3>You can delete your account any time ..,We are Working On This Feature .,Once Your'e Done with this We Will Mail You</h3>
</div>
                     <img style="" src="<?php echo(IMG.'down.png'); ?>" alt="img01" width="80" height="80">
					<br/><br/>
	...
	//echo $row->code;
				...
				?>
					...
					<figure class="cbp-so-side cbp-so-side-right">
							<img style="margin-top:-30px;" class="img-polaroid" src="<?php echo(IMG.'email.png'); ?>" alt="img01">
					</figure>
				</section>
                  <section class="cbp-so-section">
					<article class="cbp-so-side cbp-so-side-left">
...
<p>Please review this Agreement periodically for changes. If you do not agree to any of this Agreement or any changes to this Agreement, do not use, access or continue to access the Site or discontinue any use of the Site immediately.</p>
  ...
  <h4>Info!</h4>
Your'e agreeing Our T&C and Privacy Policy
</div>
